        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { name: "Fashion", icon: "👗", count: "300+ products" },
              { name: "Home & Living", icon: "🏠", count: "250+ products" },
              { name: "Health & Beauty", icon: "💄", count: "200+ products" }
            ].map((category, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 50 }}
                ...
                viewport={{ once: true }}
                className="glass p-6 text-center hover:shadow-lg transition-all duration-300 cursor-pointer"
              >
